...
//{
int sctp_get_number_streams(int sockfd, struct sctp_sndrcvinfo *sri)
{
	size_t stlen;
 ...
 */
void sctp_set_number_streams(int sockfd, struct sctp_initmsg *initm, int nstrs, int maxatmts)
{
